...
class rBST:
    ...
    def DFS_pre_order(self) -> list:
        ...
        def traverse_pre_order(current_node: Node, output: list) -> list:
            """
    ...
    def DFS_in_order(self) -> list:
        ...
        def traverse_in_order(current_node: Node, output: list) -> None:
            """
    ...
    def DFS_post_order(self) -> list:
        ...
        def traverse_post_order(current_node: Node, output: list) -> None:
            """
...
def main():
    ...
    r_bst = rBST()
    print("\n==> A recursive binary search tree is created.\n")
    # Insert nodes into the rBST
    values_to_insert = [15, 35, 55, 25, 45, 65, 85]
    print(f"\t. Insert values {tuple(values_to_insert)} into the rBST:")
